    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <h3 className="text-2xl font-bold text-white">Billing Panda</h3>
            </div>
            <p className="text-sm">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="hover:text-orange-500 transition-colors">Digital Marketing</li>
              <li className="hover:text-orange-500 transition-colors">SEO Optimization</li>
              <li className="hover:text-orange-500 transition-colors">Content Strategy</li>
              <li className="hover:text-orange-500 transition-colors">Social Media Management</li>
              <li className="hover:text-orange-500 transition-colors">Brand Development</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:info@digiagency.com" className="hover:text-orange-500 transition-colors">
                  info@digiagency.com
                </a>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm">
            &copy; {new Date().getFullYear()} Billing Panda. All rights reserved.
          </p>
